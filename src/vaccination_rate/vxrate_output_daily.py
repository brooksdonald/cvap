...
w = who.groupby(['iso_code']).sort_values(by=['date'], ascending=True)
print(" > Filter out to_remove columns with value of 0...")
df1 = who[who['to_remove', 'to_remove_1st', 'to_remove_2nd'] == 0] 
print(df1)
print(" > ") # Start here
df1 = df1    
