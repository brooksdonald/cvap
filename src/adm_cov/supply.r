...
run_new_supply <- function() {
  ...
  # July
  base_eojul$iso <-
    countrycode(base_eojul$Country.territory, origin = 'country.name',
  ...
  # August
  base_eoaug$iso <-
    countrycode(base_eoaug$Country.territory, origin = 'country.name',
                destination = 'iso3c', warn = TRUE)
  ...
  # September
  base_eosep$iso <-
    countrycode(base_eosep$Country.territory, origin = 'country.name',
                destination = 'iso3c', warn = TRUE)
  ...
  # October
  base_eooct$iso <-
    countrycode(base_eooct$Country.territory, origin = 'country.name',
                destination = 'iso3c', warn = TRUE)
  ...
  # November
  base_eonov$iso <-
    countrycode(base_eonov$Country.territory, origin = 'country.name',
                destination = 'iso3c', warn = TRUE)
  ...
  # December
  base_eodec$iso <-
    countrycode(base_eodec$Country.territory, origin = 'country.name',
                destination = 'iso3c', warn = TRUE)
  ...
  # January
  base_eojan$iso <-
    countrycode(base_eojan$Country.territory, origin = 'country.name',
                destination = 'iso3c', warn = TRUE)
  ...
  # February 
  base_eofeb$iso <-
    countrycode(base_eofeb$Country.territory, origin = 'country.name',
                destination = 'iso3c', warn = TRUE)
  ...
  # March 
  base_eomar$iso <-
    countrycode(base_eomar$Country.territory, origin = 'country.name',
                destination = 'iso3c', warn = TRUE)
  ...
  # April
  base_eoapr$iso <-
    countrycode(base_eoapr$Country.territory, origin = 'country.name',
                destination = 'iso3c', warn = TRUE)
  ...
  # May
  base_eomay$iso <-
    countrycode(base_eomay$Country.territory, origin = 'country.name',
                destination = 'iso3c', warn = TRUE)
  ...
  # June
  base_eojun$iso <-
    countrycode(base_eojun$Country.territory, origin = 'country.name',
                destination = 'iso3c', warn = TRUE)
  ...
  overall_cumul_long <- rbind(overall_cumul_jul,
                              overall_cumul_aug,
                              overall_cumul_sep,
                              overall_cumul_oct,
                              overall_cumul_nov,
  ...
  overall_red <- select(del_overall,c("iso",
                                      "2021-08",
                                      "2021-09",
                                      "2021-10",
                                      "2021-11",
  ...
  overall_long <- rbind(overall_jun, overall_may, overall_apr, overall_mar, overall_feb, 
