...
load_current_vxrate <- function {
    print(" >> Loading current vaccination rate...")
    b_vxrate <-
        data.frame(
    ...
    print(" >> Renaming daily vxrate columns...")
    colnames(b_vxrate) <-
        c(
            "a_iso",
            "a_pop",
...
transform_current_vxrate <- function(insert function above here) {
    print("")
