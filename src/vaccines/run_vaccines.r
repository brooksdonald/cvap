...
run_vaccines <- function(entity_characteristics,
    ...
    b_vxrate <- transform_current_vxrate(b_vxrate, entity_characteristics, refresh_date)
    b_vxrate_pub <- transform_current_vxrate_pub(b_vxrate) 
    b_vxrate_amc <- transform_subset_amc(b_vxrate) 
    b_vxrate_amc_smooth <- transform_smooth_timeseries(b_vxrate_amc, b_vxrate_pub, refresh_date)
    ...
    combined <- first_supplies(d_absorb_red)
