...
run_vaccines <- function(env = .GlobalEnv) {
    ...
    b_vxrate_lw_sum <- transform_lw_data(b_vxrate_lw_sum, c_vxrate_latest)
    print(" > Done.")
    ...
    b_vxrate_2m_sum <- transform_l2m_data(c_vxrate_latest, b_vxrate_2m_sum)
