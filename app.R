...
vaccines_env <- run_vaccines(entity_characteristics, refresh_date)
...
product_env <- run_product(a_data, base_env$b_smartsheet, .GlobalEnv$refresh_date, vxrate_env$timeto_t70)
