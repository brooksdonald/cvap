...
.GlobalEnv$refresh_date <- as.Date("2022-11-24")
...
all_df <- list(
  ...
  write_xlsx(all_df, "data/output/221124_output_powerbi.xlsx")
  write_xlsx(financing_env$api, "data/output/221124_output_api.xlsx")
