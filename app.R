...
.GlobalEnv$refresh_date <- as.Date("2023-02-07")
...
all_df <- list(
  ...
  write_xlsx(all_df, "data/output/230207_output_powerbi.xlsx")
  write_xlsx(financing_env$api, "data/output/230207_output_api.xlsx")
