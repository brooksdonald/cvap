...
data_checks <- function(a_data) {
  ...
  #       "")
  #   )) %>%           
  #   mutate(check_adm_a1d_fv_lm_bound = if_else(
  #     check_adm_a1d_fv_lm_lower == "Not Okay",
  #     "Lower",
  #     if_else(
  #       check_adm_a1d_fv_lm_upper == "Not Okay",
  #       "Upper",
  #       "")
  #   )) %>%           
  #   mutate(check_adm_booster_fv_lm_bound = if_else(
  #     check_adm_booster_fv_lm_lower == "Not Okay",
  #     "Lower",
  #     if_else(
  #       check_adm_booster_fv_lm_upper == "Not Okay",
  #       "Upper",
  #       "")
  #   )) %>%           
