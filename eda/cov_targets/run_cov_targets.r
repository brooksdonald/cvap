...
run_eda_cov_targets <- function(a_data, timeto_t70, c_vxrate_sept_t10, c_vxrate_dec_t2040, c_vxrate_jun_t70, t70_deadline, entity_characteristics) {
  ...
  # the following line automatically generates the suffix from `t70_deadline`. Uncomment if needed. 
