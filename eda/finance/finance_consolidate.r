...
finance_consolidate <- function(a_data) {
    print(" >> Consolidating finance data...")  
    a_data <- a_data %>%
    ...
    print(" >> Function 'finance_consolidate' done")
    return(a_data)
}
...
amc_covax_status <- function(a_data) {
    ...
    print(" >> Function 'amc_covax_status' done")
    return(a_data_amc)
}
...
hic_income_group <- function(a_data) {
    ...
    print(" >> Function 'hic_income_group' done")
    return(a_data_hic)
}
...
covdp_csc_status <- function(a_data) {
    ...
    print(" >> Function 'covdp_csc_status' done")
    return(a_data_csc)
}
...
covdp_ifc_status <- function(a_data) {
    ...
    print(" >> Function 'covdp_ifc_status' done")
    return(a_data_ifc)
}
...
africa_continent <- function(a_data) {
    ...
    print(" >> Function 'africa_continent' done")
